...
ggplot(data = dat, aes(x = match_amount)) +
    geom_histogram(colour = "grey60", fill = "darkviolet") +
    geom_vline(xintercept = mean(dat$match_amount), colour = "goldenrod3") +
...
ggplot(data = dat, aes(x = match_amount)) +
    geom_histogram(colour = "grey60", fill = "darkviolet") +
    geom_vline(data = dat2, aes(xintercept = avg), colour = "goldenrod3") +
...
ggplot(data = gitcoin_grants, aes(x = num_contributions)) +
    geom_histogram(colour = "grey60", fill = "darkviolet") +
    geom_vline(xintercept = mean(gitcoin_grants$num_contributions), colour = "chocolate1") +
    scale_x_log10(labels = scales::dollar, breaks = 10^(-2:10)) +
    scale_y_continuous(breaks = scales::pretty_breaks(n = 10),
                       labels = scales::comma) +
    labs(
...
ggplot(data = gitcoin_grants, aes(x = num_unique_contributors)) +
    geom_histogram(colour = "grey60", fill = "darkviolet") +
    geom_vline(xintercept = mean(gitcoin_grants$num_unique_contributors), colour = "goldenrod3") +
...
```{r}
dat <- gitcoin_grants %>% mutate(crowdfund_amount_contributions_usd = readr::parse_number(crowdfund_amount_contributions_usd))

ggplot(data = dat, aes(x = num_unique_contributors)) +
    geom_histogram(colour = "grey60", fill = "darkviolet") +
    geom_vline(xintercept = mean(dat$crowdfund_amount_contributions_usd, na.rm = TRUE), colour = "goldenrod3") +
    scale_x_log10(labels = scales::dollar, breaks = 10^(-2:10)) +
    scale_y_continuous(breaks = scales::pretty_breaks(n = 10),
                       labels = scales::comma) +
    labs(
...
```{r, fig.width=22}
dat2 <- dat %>% group_by(round_number) %>% summarise(avg = mean(crowdfund_amount_contributions_usd, na.rm = TRUE))
